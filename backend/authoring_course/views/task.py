...
from authoring_course.serializers import CourseTaskSerializer
...
class ListCreateCourseTask(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        return CourseTask.objects.filter(course_id=courseId)
...
class CourseTaskDetail(RetrieveUpdateDestroyAPIView):
    serializer_class = CourseTaskSerializer
    ...
    def get_queryset(self):
        return CourseTask.objects.filter(id=self.kwargs[self.lookup_url_kwarg])
