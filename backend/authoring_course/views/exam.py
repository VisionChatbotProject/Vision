...
from authoring_course.serializers import CourseExamSerializer
...
class ListCreateCourseExam(ListCreateAPIView):
    ...
    def get_queryset(self):
        ...
        return CourseExam.objects.filter(course_id=courseId)
...
class CourseExamDetail(RetrieveUpdateDestroyAPIView):
    serializer_class = CourseExamSerializer
    lookup_url_kwarg = 'examId'
    ...
    def get_queryset(self):
        return CourseExam.objects.filter(id=self.kwargs[self.lookup_url_kwarg])
