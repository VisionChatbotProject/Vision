...
def main():
    ...
    # reading nlu file
    nlu_yml = YamlHandler(input_file=constants.NLU_INPUT_FILE_PATH, output_file=constants.NLU_OUTPUT_FILE_PATH)
    ...
    # reading rules file
    rules_yml = YamlHandler(input_file=constants.RULES_INPUT_FILE_PATH, output_file=constants.RULES_OUTPUT_FILE_PATH)
    ...
    # reading domain file
    domain_yml = YamlHandler(input_file=constants.DOMAIN_INPUT_FILE_PATH, output_file=constants.DOMAIN_OUTPUT_FILE_PATH)
